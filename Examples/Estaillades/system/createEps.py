        ...
        for ipy in range(0,NPY):
            for ipx in range(0,NPX):
                           ...
                           for j in range (0,nyp):
                               for jj in range (0,q):
                                   for kk in range (0,r):
                                       ...
                                       eps_bz0[i,j]+=float(micro_por[np.squeeze(np.where(phases==a))])/p/q/r
                           ...
                           for jj in range (0,q):
                               for k in range (0,nzp):
                                   for kk in range (0,r):
                                       ...
                                       eps_by0[i,k]+=float(micro_por[np.squeeze(np.where(phases==a))])/p/q/r                     
                           ...
                           for jj in range (0,q):
                               for k in range (0,nzp):
                                   for kk in range (0,r):
                                       ...
                                       eps_bx0[j,k]+=float(micro_por[np.squeeze(np.where(phases==a))])/p/q/r
                           ...
                           for jj in range (0,q):
                               for k in range (0,nzp):
                                   for kk in range (0,r):
                                       ...
                                       eps_bx1[j,k]+=float(micro_por[np.squeeze(np.where(phases==a))])/p/q/r
                           ...
                           for jj in range (0,q):
                               for k in range (0,nzp):
                                   for kk in range (0,r):
                                       ...
                                       eps_by1[i,k]+=float(micro_por[np.squeeze(np.where(phases==a))])/p/q/r
                           ...
                           for j in range (0,nyp):
                               for jj in range (0,q):
                                   for kk in range (0,r):
                                       ...
                                       eps_bz1[i,j]+= float(micro_por[np.squeeze(np.where(phases==a))])/p/q/r
                
                f=open('processor'+str(iproc)+'/0/eps','a')
                ...
                for k in range (0,nzp):
                    for j in range (0, nyp):
                        for i in range (0, nxp):
                            num_string = format(eps[i,j,k],".8f")
                            for i in range(0,10):
                ...
                if (ipz>0):
                    ...
                    for j in range(0,nyp):
                        for i in range(0,nxp):
                            num_string = format(eps_bz0[i,j],".8f")
                ...
                if (ipy>0):
                    ...
                    for k in range(0,nzp):
                        for i in range(0,nxp):
                            num_string = format(eps_by0[i,k],".8f")
                            for ii in range(0,10):
                                if (num_string[-1]=='0') or (num_string[-1]=='.'):
                                    num_string = num_string[:-1]
                            f.write(num_string+'\n')
                ...
                if (ipx>0):
                    ...
                    for k in range(0,nzp):
                        for j in range(0,nyp):
                            num_string = format(eps_bx0[j,k],".8f")
                            for ii in range(0,10):
                                if (num_string[-1]=='0') or (num_string[-1]=='.'):
                                    num_string = num_string[:-1]
                            f.write(num_string+'\n')
                ...
                if (ipx<NPX-1):
                    ...
                    for k in range(0,nzp):
                        for j in range(0,nyp):
                            num_string = format(eps_bx1[j,k],".8f")
                            for ii in range(0,10):
                                if (num_string[-1]=='0') or (num_string[-1]=='.'):
                                    num_string = num_string[:-1]
                            f.write(num_string+'\n')
                ...
                if (ipy<NPY-1):
                    ...
                    for k in range(0,nzp):
                        for i in range(0,nxp):
                            num_string = format(eps_by1[i,k],".8f")
                            for ii in range(0,10):
                                if (num_string[-1]=='0') or (num_string[-1]=='.'):
                                    num_string = num_string[:-1]
                            f.write(num_string+'\n')
                ...
                if (ipz<NPZ-1):
                    ...
                    for j in range(0,nyp):
                        for i in range(0,nxp):
                            num_string = format(eps_bz1[i,j],".8f")
                            for ii in range(0,10):
                                if (num_string[-1]=='0') or (num_string[-1]=='.'):
                                    num_string = num_string[:-1]
                            f.write(num_string+'\n')                        
