...
# if pre-loading python modules then load remaining subprocess libraries here
import numpy as np
import array
import argparse
...
subprocess.run(['python', 'system/createcellmeshpar.py',
                   '--xDim', str(x_dim), 
                   '--yDim', str(y_dim),
                   '--zDim', str(z_dim),
                   '--xMin', str(x_min),
...
subprocess.run(['python', 'system/createpointmeshpar.py',
                   '--xDim', str(x_dim),
                   '--yDim', str(y_dim),
                   '--zDim', str(z_dim),
                   '--xMin', str(x_min),
...
subprocess.run(['python', 'system/createfacemeshpar.py',
                   '--xDim', str(x_dim),
                   '--yDim', str(y_dim),
                   '--zDim', str(z_dim),
                   '--xMin', str(x_min),
...
subprocess.run(['python', 'system/createboundarymeshpar.py',
                   '--xDim', str(x_dim),
                   '--yDim', str(y_dim),
                   '--zDim', str(z_dim),
                   '--xMin', str(x_min),
...
subprocess.run(['python', 'system/createEpspar.py',
                   '--xDim', str(x_dim),
                   '--yDim', str(y_dim),
                   '--zDim', str(z_dim),
                   '--xMin', str(x_min),
...
subprocess.run(['python', 'system/createKinvpar.py',
                   '--xDim', str(x_dim),
                   '--yDim', str(y_dim),
                   '--zDim', str(z_dim),
                   '--xMin', str(x_min),
