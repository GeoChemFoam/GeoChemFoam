...
sed -i "s/z1/$z1/g" system/setFieldsDict
sed -i "s/x2/$x2/g" system/setFieldsDict
sed -i "s/y2/$y2/g" system/setFieldsDict
sed -i "s/z2/$z2/g" system/setFieldsDict
...
setFields > setFieldsT.out 

if [ -d "processor0" ]
then
    echo -e "reconstructPar"
    reconstructPar -withZero > reconstructParT.out
